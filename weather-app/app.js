...
const locationURL = "https://api.mapbox.com/geocoding/v5/mapbox.places/New%20York.json?access_token=pk.eyJ1IjoiY2c3MDkiLCJhIjoiY2tpNWx4d216Mjk4ZzJwbzMxYzE1MGY2OSJ9.ZC2jB_23iHamKQ6f9wXzTQ&limit=1"

request({url: locationURL, json: true}, (error, response)=>{
    if (error){
        console.log(error);
        console.log('Low-level OS error')
    } else if (response.body.features.length === 0){
        console.log('Enter right location'); 
    } else {
